...
startProduction | Start of production phase | date | 1..1 | The date when the repository moves or will move into the production phase. This can also be a planned date in the future.
...
fundingProject | Funding projects | handle reference | 1..n | Funding grants or projects. Provide a link to an object of type Project.
