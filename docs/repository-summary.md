...
additionalNames | Alternative repository names | object | 0..n | Alternative repository name or acronym of the official repository name.
additionalNames.additionalName | Alternate name | string | 1..1 | 
additionalNames.lang | Language | enum | 0..1 | 
