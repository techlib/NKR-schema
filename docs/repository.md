...
status | Repository status | enum | 0..1 | Actual repository development or production status (development, test, pilot - not accepting data, pilot - accepting data, production, decomissioned, offline).
...
contactList | Contact list  | handle reference | 0..1 | Contact list for the repository. Provide a link to an object of type ContactList.
...
organization.organizationId | Organization | handle reference | 1..1 | Organization with a role to the repository. Provide a link to an object of type Organization.
organization.organizationRole | Role | enum | 1..1 | Role of the organization (founder, partner).
...
serviceQueue | Service Queue  | handle reference | 0..1 | Service queue for the repository. Provide a link to an object of type ServiceQueue.
